<section id="roles">
	...
	<div id="banner_image">
		...
		<img class="estate_banner_img" src="<?php echo getenv('UPLOAD_ROOT').$career->career_image; ?>" draggable="false" alt="<?php echo $career->career_alt_image; ?>" title="<?php echo $career->career_alt_image; ?>" />
