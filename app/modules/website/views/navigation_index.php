...
<?php $current_estate = str_replace('/estates/', '', $_SERVER['REQUEST_URI']);  ?>
<nav class="navi-bar navbar-expand-lg navbar-light fixed-top">
  ...
  <div class="collapse navbar-collapse" id="mobile_navbar">
    <ul class="navbar-nav">
        <?php  $navigations = $this->navigations_model->get_frontend_navigations(1); 
		foreach ($navigations as $key => $value) { ?>
			<li class="nav-item mobile_main_li <?php echo (substr($request,0,4) == substr($value->navigation_link,0,4)) ? 'active' : ''; ?>">	
				<a class="nav-link mobile_main_a" href="<?php echo site_url($value->navigation_link); ?>">
					<span><?php echo $value->navigation_name; ?></span>
				</a>
					<?php if($value->navigation_link == "estates"){ ?>
						<ul class = "mobile_estate_sub_link">
							<?php
							...
							?>		
								<li class="nav-item <?php echo ($current_estate == $estate->estate_slug) ? 'active' : ''; ?>">
									<a class="nav-link" href="<?php echo site_url('').'estates/'.$estate->estate_slug; ?>">
		...
		<?php  }  ?>
		<?php  $navigations = $this->navigations_model->get_frontend_navigations(2); 
		foreach ($navigations as $key => $value) { ?>
			<li class="nav-item mobile_main_li <?php echo (substr($request,0,4) == substr($value->navigation_link,0,4)) ? 'active' : ''; ?>">
				<a class="nav-link mobile_main_a" href="<?php echo site_url($value->navigation_link); ?>">
					<span><?php echo $value->navigation_name; ?></span>
	...
	<div class="container">
		<div class="oclogo">
			<div class="row">
				...
				<div class="col-lg-4">
					<div id="new_search" class="d-flex flex-row-reverse">
