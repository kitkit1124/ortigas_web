		...
		<div class="card">
			<div class="card-close">
				<div class="card-buttons">
					<?php if ($this->acl->restrict('properties.price_range.add', 'return')): ?>
						<a href="<?php echo site_url('properties/price_range/form/add')?>" data-toggle="modal" data-target="#modal" class="btn btn-sm btn-primary btn-add" id="btn_add"><span class="fa fa-plus"></span> <?php echo lang('button_add')?></a>
					<?php endif; ?>
				</div>
			</div>
				...
				<table class="table table-striped table-bordered table-hover dt-responsive" id="datatables">
					<thead>
						<tr>
							...
							<th class="all"><?php echo lang('index_label'); ?></th>
							<th class="min-desktop"><?php echo lang('index_range'); ?></th>
							<th class="none"><?php echo lang('index_max'); ?></th>
