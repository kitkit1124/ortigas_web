<section id="roles">
	<div class="container-fluid">
		<div class="card">
			<div class="card-close">
				<div class="card-buttons">
					<?php if ($this->acl->restrict('properties.property_sliders.add', 'return')): ?>
						<a href="<?php echo site_url('properties/property_sliders/form/add')?>" data-toggle="modal" data-target="#modal" class="btn btn-sm btn-primary btn-add" id="btn_add"><span class="fa fa-plus"></span> <?php echo lang('button_add')?></a>
					<?php endif; ?>
				</div>
			</div>
			...
			<th class="min-desktop"><?php echo lang('index_image'); ?></th>
			<th class="min-desktop"><?php echo lang('index_title'); ?></th>
			<th class="min-desktop"><?php echo lang('index_title_size'); ?></th>
			<th class="min-desktop"><?php echo lang('index_title_pos'); ?></th>
			<th class="min-desktop"><?php echo lang('index_caption'); ?></th>
			<th class="min-desktop"><?php echo lang('index_caption_size'); ?></th>
			<th class="min-desktop"><?php echo lang('index_caption_pos'); ?></th>
