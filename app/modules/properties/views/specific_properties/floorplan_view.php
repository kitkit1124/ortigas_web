		...
		<div id="unit-img" >
			<center>
				<a class="floorplan_image_link" href="<?php echo site_url().'properties/properties/floorplan_image?img='.getenv("UPLOAD_ROOT").'data/photos/building-floorplan.png' ?>" data-target="#modal-lg" data-toggle="modal">
					<img id="floorplan_image" src="<?php echo site_url(); ?>data/images/building-floorplan.png" onerror="this.onerror=null;this.src='<?php echo site_url('ui/images/placeholder.png')?>';">
				</a>
			</center>
		</div>
		<div id="unit-reserve">
